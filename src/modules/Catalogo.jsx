...
const Catalogo = () => {
  // estructuras
  const productos = [
    { nombre: "Elefante", img: img1, cat: "Flores decorativas (macetas medianas)" },
    { nombre: "muneca rubia", img: img2, cat: "Flores decorativas (macetas medianas)" },
    // { nombre: "animales", img: img3, cat: "Tulipanes en macetas y bucaros" },
    // { nombre: "spiderman", img: img4, cat: "Tulipanes en macetas y bucaros" },
    // { nombre: "perrito", img: img5, cat: "Tulipanes en macetas y bucaros" },
    // { nombre: "godzilla", img: img6, cat: "Tulipanes en macetas y bucaros" },
    // { nombre: "unicornio", img: img7, cat: "Tulipanes en macetas y bucaros" },
    // { nombre: "mini", img: img8, cat: "Tulipanes en macetas y bucaros" },
    ...
    // { nombre: "perrito", img: img17, cat: "cintillos para niñas" },
    // { nombre: "yoda", img: img18, cat: "cintillos para niñas" },
    // { nombre: "lady bougt", img: img19, cat: "cintillos para niñas" },
    // { nombre: "miraculos", img: img20, cat: "cintillos para niñas" },
    // { nombre: "gaticox2", img: img21, cat: "carruseles para bebés" },
    // { nombre: "mario", img: img22, cat: "carruseles para bebés" },
    // { nombre: "mujer", img: img23, cat: "carruseles para bebés" },
    // { nombre: "cap america", img: img24, cat: "carruseles para bebés" },
    // { nombre: "coneja", img: img25, cat: "carruseles para bebés" },
    // { nombre: "pocoyo", img: img26, cat: "carruseles para bebés" },
    // { nombre: "muneca", img: img27, cat: "cuadros decorativos para habitaciones" },
    // { nombre: "sirenita ariel", img: img28, cat: "cuadros decorativos para habitaciones" },
    // { nombre: "gato negro", img: img29, cat: "cuadros decorativos para habitaciones" },
    ...
    // { nombre: "doctora rubia", img: img33, cat: "cuadros decorativos para parejas" },
    // { nombre: "granjeros", img: img34, cat: "cuadros decorativos para parejas" },
    // { nombre: "happy", img: img35, cat: "cuadros decorativos para parejas" },
    // { nombre: "cohala", img: img36, cat: "cuadros decorativos para parejas" },
    // { nombre: "costurera", img: img37, cat: "cuadros decorativos para parejas" },
    ...
    // { nombre: "mohana", img: img42, cat: "cuadros para bebés" },
    // { nombre: "mohana", img: img43, cat: "cuadros para bebés" },
    // { nombre: "mohana", img: img44, cat: "cuadros para bebés" },
    // { nombre: "mohana", img: img45, cat: "cuadros para bebés" },
    // { nombre: "mohana", img: img46, cat: "cuadros para bebés" },
    // { nombre: "mohana", img: img47, cat: "cuadros para bebés" },
    ...
    // { nombre: "mohana", img: img55, cat: "captus tejidos pequeños" },
    // { nombre: "mohana", img: img56, cat: "captus tejidos pequeños" },
    ...
    // { nombre: "mohana", img: img83, cat: "Suculentas a crochet" },
    // { nombre: "mohana", img: img84, cat: "Suculentas a crochet" },
    // { nombre: "mohana", img: img85, cat: "Suculentas a crochet" },
    // { nombre: "mohana", img: img86, cat: "Suculentas a crochet" },
    ...
    // { nombre: "mohana", img: img91, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img92, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img93, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img94, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img95, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img96, cat: "Flores decorativas (macetas grandes)" },
    // { nombre: "mohana", img: img97, cat: "Flores decorativas (macetas grandes)" },
    ...
    // { nombre: "mohana", img: img129, cat: "carteras medianas" },
  ...
  const subcate = [
    ...
    { nombre: "Decoraciones tejidas temática café", padre: "Para El Hogar" },
    { nombre: "caudros decorativos para el hogar", padre: "Para El Hogar" },
    { nombre: "captus tejidos pequeños", padre: "Para El Hogar" },
    { nombre: "captus grandes a crochet", padre: "Para El Hogar" },
    { nombre: "captus amigurumis", padre: "Para El Hogar" },
    { nombre: "llaveros personalizados", padre: "Personalizar" },
    { nombre: "cuadros personales", padre: "Personalizar" },
    { nombre: "cuadros para bebés", padre: "Personalizar" },
    { nombre: "cuadros familiares", padre: "Personalizar" },
    { nombre: "cuadros decorativos para parejas", padre: "Personalizar" },
    { nombre: "amigurumis personalizados", padre: "Personalizar" },
    { nombre: "Pareja de captus", padre: "Especiales Para Parejas" },
    ...
    { nombre: "Decoraciones para estetoscopio", padre: "Accesorios" },
    { nombre: "coleccion de llaveros de ojos turcos", padre: "Accesorios" },
    { nombre: "carteras medianas", padre: "Accesorios" },
    { nombre: "Bolsos para móviles", padre: "Accesorios" },
    { nombre: "Aretes tejidos", padre: "Accesorios" },
    {
      nombre: "cuadros decorativos para habitaciones",
      padre: "Para Los Pequeños",
    },
    { nombre: "cintillos para niñas", padre: "Para Los Pequeños" },
    { nombre: "carruseles para bebés", padre: "Para Los Pequeños" },
  ];

  // funciones

  const wasa = () => {
    window.location.assign("https://wa.me/5353792502");
  }
  ...
  const [subcat, setSubcat] = useState("Amigurumis especiales");
      ...
      productos
        ...
        .map((valor) => (
          <div className="card spr" key={valor.img}>
            ...
            <div className="card__content">
              <p className="card__text text">Precio</p>
              <p className="abrirModal" onClick={wasa}>
                <svg
                  fill="rgb(102, 204, 102)"
                  xmlns="http://www.w3.org/2000/svg"
                  width="3vw"
